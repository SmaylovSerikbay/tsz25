...
urlpatterns = [
    ...
    path('create-order/', views.create_order_request, name='create_order'),
    ...
    # Chat URLs
    path('chat/<int:order_id>/messages/', views.get_chat_messages, name='get_chat_messages'),
    path('chat/<int:order_id>/send/', views.send_chat_message, name='send_chat_message'),
